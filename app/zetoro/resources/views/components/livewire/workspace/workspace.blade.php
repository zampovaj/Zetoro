<div class="flex flex-col h-full">
    <div class="flex bg-gray-900 overflow-x-auto border-b border-gray-700 hide-scrollbar">
        ...
        <div @class([
            ...
            'bg-gray-800 text-white border-t-2 border-t-blue-500' => $activeTabId === $tab["id"],
            'bg-gray-900 text-gray-400 hover:bg-gray-800' => $activeTabId !== $tab["id"],
        ]) >                
            ...
            @forelse ($openTabs as $tab)
                <div
                    ...
                    <livewire:livewire.pdf-annotator
                        :fileId="$tab['id']" :wire:key="'pdf-'.$tab['id']" >
                    </livewire:livewire.pdf-annotator>
                </div>
            @empty
