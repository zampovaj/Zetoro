<div x-data="{
    ...
    class="fixed z-50 px-3 py-2 text-sm font-medium text-white bg-zinc-900 dark:bg-zinc-700 rounded-lg shadow-lg pointer-events-auto max-w-md max-h-48 overflow-y-auto whitespace-pre-wrap"
    style="display: none;">
</div>
